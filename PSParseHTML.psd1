...
@{
    ...
    FunctionsToExport = 'Format-HTML', 'Optimize-HTML', 'Optimize-ResourceFile', 
    'Optimize-ResourceFolder'
    ...
    AliasesToExport = 'New-MinifiFile', 'New-MinifyFile', 'New-MinifiFolder', 
    'New-MinifyFolder'
