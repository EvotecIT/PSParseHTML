#
# Module manifest for module 'PSParseHTML'
#
...
@{
    ...
    FunctionsToExport    = 'Convert-HTMLToText', 'ConvertFrom-HTMLAttributes', 
    'ConvertFrom-HtmlTable', 'Format-CSS', 'Format-HTML', 
    'Format-JavaScript', 'Optimize-CSS', 'Optimize-HTML', 
    'Optimize-JavaScript'
